...
<body>
	<h3>회원가입</h3>
	 accept-charset="utf-8" : 폼 데이터(form data)를 서버로 보낼 때 사용되는 문자 인코딩(character encoding) 방식을 명시하는 속성
	 디폴트값은 “UNKNOWN”이며, 명시하지 않을 경우 html문서의 인코딩에 맞춰 전송함<br><br>
	
	<form action="08_05_02_form05_process.jsp" name="member" method="post" accept-charset="utf-8">
